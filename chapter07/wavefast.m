...
%   image (or matrix) X with respect to decomposition filters LP and HP.
%
...
%     approximation, horizontal, vertical, and diagonal coefficient matrices, respectively.
%     C has 3n + 1 sections where n is the number of wavelet decompositions. 
%
